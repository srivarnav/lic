...
Label (root1,text="Min term = 12yrs",font="verdana 12 bold ").grid(row=2,column=2)
Label (root1,text="Max term = 35yrs",font="verdana 12 bold ").grid(row=3,column=2)
Label (root1,text="Min S.A. = Rs 75000 + 5000 thereafter",font="verdana 12 bold ").grid(row=4,column=2)
...
def calculate():
    ...
    print sa,type(sa),type(mode),type(mode),tp,type(tp)
