...
Label (root1,text="Enter age from 18-50",font="verdana 12 bold ").grid(row=1,column=2)
Label (root1,text="Min term = 15yrs",font="verdana 12 bold ").grid(row=2,column=2)
Label (root1,text="Max term = 35yrs",font="verdana 12 bold ").grid(row=3,column=2)
Label (root1,text="Min S.A. = Rs 100000 and in multiples of 5000",font="verdana 12 bold ").grid(row=4,column=2)
...
v1 = IntVar()
w=OptionMenu(root1,v1,"15","20","25","30","35").grid(row=6,column=3)

Label (root1,text="Enter Age [18-50] :",font="verdana 10").grid(row=7,column=1)
e2=Entry(root1,bd=5)
